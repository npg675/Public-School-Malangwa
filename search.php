...
$pagesIndex = [
  ...
  ['type'=>'Page','title'=>'News & Events','url'=>base_url('news-events.php'),'meta'=>'Completed activities and scheduled programs','kw'=>'news samachar activity event report karyakram upcoming'],
