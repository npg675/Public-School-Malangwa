  ...
  <div class="wrap">
    ...
    <div style="max-width:900px;margin:14px auto 0;background:#fff;border:1px solid var(--border);border-radius:12px;padding:18px">
      ...
      <div style="margin-top:12px;display:grid;gap:12px">
        ...
        <details style="background:var(--surface-low);border:1px solid var(--border);border-radius:10px;padding:12px 14px"><summary style="font-weight:700;cursor:pointer">Are examination results available online?</summary><p style="color:var(--muted);font-size:.88rem;margin-top:8px;line-height:1.6">Published results and exam updates are announced on the <a href="<?= e_attr(base_url('notices.php')) ?>" style="color:var(--primary);font-weight:700">Notice Board</a>, and result-related documents are available in <a href="<?= e_attr(base_url('downloads.php')) ?>" style="color:var(--primary);font-weight:700">Downloads</a>. Official marksheets are verified through the school office.</p></details>
      </div>
