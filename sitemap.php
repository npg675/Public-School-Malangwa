...
$base = rtrim(base_url(), '/');
$pages = ['','about.php','academics.php','science.php','management.php','admissions.php','notices.php','news-events.php','results.php','downloads.php','publications.php','citizen-charter.php','scholarships.php','academic-calendar.php','links.php','gallery.php','contact.php','faq.php'];
