...
<section class="section" style="padding-top:24px;background:#fff;border-top:1px solid var(--border)">
  <div class="wrap">
    ...
    <div class="download-list">
      ...
      <div class="dl-row"><span class="dl-icon"><svg class="ic"><use href="#i-doc"/></svg></span><div class="dl-body"><h4><?= e($dl['title_en']) ?></h4><div class="dl-meta"><span><?= e($dl['cat_en']??$dl['category']) ?></span><span>•</span><span><?= e($dl['published_at']) ?></span><span>•</span><span><?= e($dl['file_size']??'') ?> <?= e($dl['file_type']??'PDF') ?></span><?php if(!empty($dl['file_type'])): ?><span style="background:var(--primary);color:#fff;padding:2px 6px;border-radius:999px;font-weight:700"><?= e($dl['file_type']) ?></span><?php endif; ?><?php if(!empty($dl['is_sample'])): ?><span style="background:var(--gold-50);border:1px solid #FDE68A;color:#6B4F00;padding:2px 8px;border-radius:999px;font-weight:700">Sample — file upload pending</span><?php endif; ?></div></div><div class="dl-actions"><?php if(!empty($dl['is_sample'])): ?><span class="btn btn-ghost" style="opacity:.55;cursor:not-allowed">File pending</span><?php else: ?><a href="<?= e_attr(base_url('uploads/'.ltrim($dl['file_path']??'','/'))) ?>" class="btn btn-soft">View</a><a href="<?= e_attr(base_url('uploads/'.ltrim($dl['file_path']??'','/'))) ?>" class="btn btn-ghost" download>Download</a><?php endif; ?></div></div>
      <?php endforeach; ?>
      <?php if($shown===0): ?>
