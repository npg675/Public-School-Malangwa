<?php $page='citizen-charter'; $title='Citizen Charter — नागरिक वडापत्र | Shree Public Secondary School'; $description='Citizen Charter (नागरिक वडापत्र) of Shree Public Secondary School, Malangwa-2 — services, required documents, responsible officer, time, fees and complaint point.'; require_once __DIR__.'/includes/helpers.php'; require_once __DIR__.'/includes/header.php';
$ccPage = get_page_content('citizen-charter'); ?>
...
<section class="section" style="padding-top:28px;background:#fff;border-top:1px solid var(--border)">
  <div class="wrap">
    ...
    <div style="background:var(--surface-low);border:1px solid var(--border);border-radius:12px;padding:20px">
      <span class="eyebrow"><span class="dot"></span> <?= e(t('About the Citizen Charter','नागरिक वडापत्र बारे')) ?></span>
      <h2 style="margin:12px 0 10px;font-size:1.25rem"><?= e(t('What this document represents','यो दस्तावेजले के प्रतिनिधित्व गर्दछ')) ?></h2>
      <?php if ($ccPage && trim(page_val($ccPage,'content')) !== ''): ?>
        <div style="color:var(--muted);line-height:1.75;font-size:.92rem;max-width:760px"><?= page_val($ccPage,'content') ?></div>
      <?php else: ?>
